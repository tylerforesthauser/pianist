...
def render_midi(composition: Composition, out_path: str | Path) -> Path:
    """
    Render a validated Composition into a standard MIDI file.
    """
    ...
    conductor.append(mido.MetaMessage("set_tempo", tempo=mido.bpm2tempo(composition.bpm), time=0))
