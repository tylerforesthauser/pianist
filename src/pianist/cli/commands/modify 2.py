...
def handle_modify(args) -> int:
    ...
    try:
        ...
        if args.render:
            ...
            out_midi_path = (
                resolve_output_path(args.out_midi_path, output_dir, "composition.mid", "modify")
                if args.out_midi_path is not None
                else None
            )
        prompt_out_path = (
            resolve_output_path(args.prompt_out_path, output_dir, "prompt.txt", "modify")
        ...
        if provider:
            ...
            elif args.raw_out_path is not None:
