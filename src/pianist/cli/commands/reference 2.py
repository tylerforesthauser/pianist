...
def setup_parser(parser):
    ...
    # Get reference
    ref_get = reference_sub.add_parser(
        "get", help="Get a reference by ID and output its composition."
    )
    ...
    # Coverage report
    reference_sub.add_parser(
        "coverage", help="Show coverage statistics by style, form, and technique."
    )
