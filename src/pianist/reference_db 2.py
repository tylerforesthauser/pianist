...
class ReferenceDatabase:
    ...
    def get_coverage(self) -> dict[str, Any]:
        ...
        # Count by style
        cursor.execute(
            "SELECT style, COUNT(*) FROM musical_references WHERE style IS NOT NULL GROUP BY style"
        )
        ...
        # Count by form
        cursor.execute(
            "SELECT form, COUNT(*) FROM musical_references WHERE form IS NOT NULL GROUP BY form"
        )
